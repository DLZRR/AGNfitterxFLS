    ...
    def PROPS(self):
        ...
        if self.cat['filetype'] == 'ASCII': 
            ...
            if self.cat['use_central_wavelength']:
                ...
                values = np.loadtxt(self.cat['path'] + 'models/FILTERS/ALL_FILTERS_info.dat', delimiter = '|', usecols=[3], skiprows = 1)
                ...
                for i in range(len(dictionary.keys())):
                    ...
                    for j in range(len(names)):
                        ...
                        if dictionary.keys()[i] == names[j] and dictionary[dictionary.keys()[i]][0]:
                            ...
                            list_values.append([ dictionary[dictionary.keys()[i]][1], values[j]])
                ...
                sortedwl = sorted(list_values, key=getkeynumber)
